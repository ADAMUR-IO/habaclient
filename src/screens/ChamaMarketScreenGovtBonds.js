...
const ChamaMarketScreenGovtBonds = () => {
  ...
  const bondsData = [
    ...
    {
      symbol: "Retail Infrastructure Bond (M-Akiba)",
      color: ["#4B0082", "#A982D3"],
    },
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity style={styles.bondItem}>
      <LinearGradient colors={item.color} style={styles.bondCard}>
        {item.image && <Image source={item.image} style={styles.bondImage} />}
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.title}>
          Select the <Text style={styles.titleHighlight}>Government Bonds</Text>{" "}
...
export default ChamaMarketScreenGovtBonds;
