    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Text style={styles.title}>
          Select the coins you want to invest in?
            ...
            <TouchableOpacity key={crypto.id} style={styles.cryptoCard}>
              <View style={styles.cryptoCardImageContainer}>
                <View style={styles.cryptoCardImageBackground}>
                  <Image source={crypto.image} style={styles.cryptoCardImage} />
                </View>
              </View>
      ...
      <View style={styles.bottomContainer}>
        <TouchableOpacity
          style={styles.button}
          onPress={() => navigation.navigate("SignUpTime")}
        >
...
export default MarketScreenNotSure;
