...
import { UserIcon, ChevronLeftIcon } from "react-native-heroicons/outline";
import { useNavigation } from "@react-navigation/native";
import img1 from "../Imgs/Girlchatting.png";
import { SafeAreaView } from "react-native-safe-area-context";

const GirlChattingWallet = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.bottomContainer}>
        <TouchableOpacity
          style={styles.button}
          onPress={() => navigation.navigate("PhoneNumberWallet")}
        >
...
export default GirlChattingWallet;
