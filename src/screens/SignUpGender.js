...
const SignUpGender = ({ route }) => {
  ...
  const handleContinue = () => {
    ...
    navigation.navigate("SignUpBDay", {
      fullName,
      phoneNumber,
      email,
      password,
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <View style={styles.slider}>
          ...
          <View
            style={[
              styles.sliderItem,
              activePage === 3 && styles.activeSliderItem,
            ]}
          />
          <View
            style={[
      ...
      <View style={styles.radioButtonContainer}>
        ...
        >
          <RadioButtonItem
            value="Male"
            label={<Text style={styles.radioButtonLabel}> Male</Text>}
          />

          <RadioButtonItem
            value="Female"
            label={<Text style={styles.radioButtonLabel}> Female</Text>}
          />

          <RadioButtonItem
            value="Prefer not to say"
            label={
              <Text style={styles.radioButtonLabel}> Prefer not to say</Text>
            }
          />
        </RadioButtonGroup>
      </View>
