...
const ChamaMarketScreenStocks = () => {
  ...
  const stocksData = [
    ...
    },
    {
      symbol: "SFC",
      amount: "30.87",
      color: ["rgba(58, 173, 44, 0.87)", "rgba(58, 173, 44, 0.78)"],
      image: sfc,
    },
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity style={styles.stockItem}>
      <LinearGradient colors={item.color} style={styles.stockCard}>
        {item.image && <Image source={item.image} style={styles.stockImage} />}
...
export default ChamaMarketScreenStocks;
